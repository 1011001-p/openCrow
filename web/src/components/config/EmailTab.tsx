        ...
        <div className="px-4 pb-4 space-y-4 border-t border-white/10 pt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Input
              ...
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].label = e.target.value;
                  return c;
                })
              }
            />
            <Input
              ...
              onBlur={(e) => {
                if (!acct.imapHost) runAutoconfig(e.target.value);
              }}
            />
            <Input
              label="IMAP Host"
              ...
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].imapHost = e.target.value;
                  return c;
                })
              }
            />
            <Input
              ...
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].imapPort = parseInt(e.target.value) || 0;
                  return c;
                })
              }
            />
            <Input
              label="IMAP Username"
              value={acct.imapUsername ?? ""}
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].imapUsername = e.target.value;
                  return c;
                })
              }
            />
            <Input
              label="IMAP Password"
              type="password"
              value={acct.imapPassword ?? ""}
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].imapPassword = e.target.value;
                  return c;
                })
              }
            />
            <Input
              ...
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].smtpHost = e.target.value;
                  return c;
                })
              }
            />
            <Input
              ...
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].smtpPort = parseInt(e.target.value) || 0;
                  return c;
                })
              }
            />
            <Input
              ...
              type="number"
              value={acct.pollIntervalSeconds || 900}
              onChange={(e) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].pollIntervalSeconds =
          ...
          <div className="flex items-center gap-6">
            <Toggle
              ...
              onChange={(v) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].tls = v;
                  return c;
                })
              }
            />
            <Toggle
              ...
              onChange={(v) =>
                updateConfig((c) => {
                  c.integrations.emailAccounts[i].enabled = v;
                  return c;
                })
              }
            />
            {autoconfStatus && (
              <span className="text-xs text-cyan font-mono ml-auto">{autoconfStatus}</span>
            )}
          </div>
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button
              ...
              onClick={() =>
                updateConfig((c) => {
                  c.integrations.emailAccounts.splice(i, 1);
                  return c;
                })
              }
            >
      ...
      <SectionHeader
        ...
        action={
          <Button
            ...
            title={
              config.integrations.emailAccounts.some((a) => !a.address?.trim())
                ? "Fill in the address of the existing account first"
                : undefined
            }
            onClick={() =>
              updateConfig((c) => {
